...
harmful_ingredients = {
    ...
    "Е301": "Хранителната добавка натриев аскорбат – производно на витамин С. В индустрията се използва като мощен антиоксидант, консервант и регулатор на киселинността, който предотвратява гранясването и потъмняването на храните",
    "Е621": "Натриев глутамат (главоболие, алергии)",
    "Е451": "хранителна добавка (трифосфат)",
    ...
    "Е307": "Се използва като антиоксидант и витамин - за удължаване срока на годност на мазнините и маслата, също за обогатяването им с витамин Е",
